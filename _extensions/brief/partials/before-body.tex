...
$if(formal)$
\setkomavar{fromlogo}{\includegraphics[width=\textwidth]{_extensions/brief/Uni_CCTB_Logo}}
...
$else$
\setkomavar{fromlogo}{\includegraphics[width=.4\textwidth]{_extensions/brief/CCTB_Logo}}
